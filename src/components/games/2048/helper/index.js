import MaliMerge from "../../../../sounds/2048/Mala.mp3";
import VelikiMerge from "../../../../sounds/2048/Velika.mp3";
    ...
    for (var row = 0; row < this.size; ++row) {
      ...
      for (var target = 0; target < this.size; ++target) {
        ...
        if (currentRow.length > 0 && currentRow[0].value === targetTile.value) {
          ...
          if(tile1.value + tile2.value >= 128){
            const audio = new Audio(VelikiMerge);
            audio.play();
          } else {
            const audio = new Audio(MaliMerge);
            audio.play();
          }
        }
